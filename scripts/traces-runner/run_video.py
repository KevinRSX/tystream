...
try:
	...
	if abr_algo == 'RL':
		command = 'exec /usr/bin/python ../rl_server/rl_server_no_training.py ' + trace_file + ' ' + str(t)
	elif abr_algo == 'fastMPC':
		command = 'exec /usr/bin/python ../rl_server/mpc_server.py ' + trace_file + ' ' + str(t)
	elif abr_algo == 'robustMPC':
		command = 'exec /usr/bin/python ../rl_server/robust_mpc_server.py ' + trace_file + ' ' + str(t)
	else:
		command = 'exec /usr/bin/python ../rl_server/simple_server.py ' + abr_algo + ' ' + trace_file + ' ' + str(t)
