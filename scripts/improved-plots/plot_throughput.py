...
MS_PER_BIN = float(sys.argv[1])
file_paths = [sys.argv[2], sys.argv[3], sys.argv[4]]
output_file = sys.argv[5]
congestion_control_types = ['CUBIC', 'BBR', "Sprout"]
...
with open(output_file, 'w') as of:
    for i in range(len(congestion_control_types)):
        t, cap, duration, mean_throughput = read_info(file_paths[i], congestion_control_types[i])
